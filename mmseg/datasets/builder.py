...
def build_dataset(cfg, default_args=None):
    ...
    from mmseg.datasets import UDADataset, SSLDataset
    if cfg['type'] == 'UDADataset':
        dataset = UDADataset(
            source=build_dataset(cfg['source'], default_args),
            target=build_dataset(cfg['target'], default_args),
            cfg=cfg)
    elif cfg['type'] == 'SSLDataset':
        dataset = SSLDataset(
            labeled=build_dataset(cfg['labeled'], default_args),
            unlabeled=build_dataset(cfg['unlabeled'], default_args),
            cfg=cfg)
