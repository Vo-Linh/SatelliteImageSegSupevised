# UNetFormer + ResNeXt101 on OpenEarthMap - Train on 1500 samples
# DA Position Ablation: AFTER FUSION
# Reference: unetformer_openearthmap_train3500_40k_resnext101_32x16d_postfusion.py
#
# Features:
#   - max_groups: 32 (fewer prototypes for 64-dim space)
#   - temperature: 0.1 (sharper EM soft assignments)
#   - ema_decay: 0.9 (cross-batch EMA memory)
#   - min_quality: 0.3 (quality gate filtering)
#   - Boosted DA component learning rates (lr_mult=5.0)
...
work_dir = './work_dirs/openearthmap/position_ablation/unetformer_resnext101_train1500_after_fusion'
data = dict(
    samples_per_gpu=8,
    workers_per_gpu=2,
    train=dict(
