# DA Position Ablation: SegFormer MiT-B5 - Train on 1500 samples
# DA Position: BEFORE FUSION
# For Exp 2/7: DA Position Ablation Study
...
work_dir = './work_dirs/openearthmap/position_ablation/segformer_mitb5_train1500_before_fusion'
