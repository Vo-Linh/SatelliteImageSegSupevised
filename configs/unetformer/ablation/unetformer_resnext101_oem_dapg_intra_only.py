# DAPG sub-component ablation: L_intra ONLY (inter & quality disabled)
# Dynamic Anchor Prototype Grouping loss = L_intra + 0*L_inter + 0*L_quality
...
model = dict(
    ...
    decode_head=dict(
        ...
        # --- Ablation: DAPG only, L_intra component only ---
        boundary_lambda=0.0,
        proto_lambda=0.1,
...
work_dir = './work_dirs/openearthmap/ablation/unetformer_resnext101_dapg_intra_only'
