# DAPG sub-component ablation: L_intra + L_inter (quality disabled)
# Dynamic Anchor Prototype Grouping loss = L_intra + lambda_inter*L_inter + 0*L_quality
...
model = dict(
    ...
    decode_head=dict(
        ...
        # --- Ablation: DAPG only, L_intra + L_inter components ---
        boundary_lambda=0.0,
        proto_lambda=0.1,
...
work_dir = './work_dirs/openearthmap/ablation/unetformer_resnext101_dapg_intra_inter'
