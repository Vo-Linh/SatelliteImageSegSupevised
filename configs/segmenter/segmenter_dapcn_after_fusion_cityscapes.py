# SegMenter with DAPCN head (after fusion) on Cityscapes
# Pure ViT backbone with dynamic anchor prototype-guided contrastive learning
# Applied after feature fusion in the decoder
...
model = dict(
    ...
    decode_head=dict(
        ...
        in_channels=768,
        in_index=-1,  # Use last ViT feature (layer 11)
        channels=768,
        num_classes=19,
        embed_dim=768,
        num_heads=12,
