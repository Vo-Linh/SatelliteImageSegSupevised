# ---------------------------------------------------------------
# DDRNet + Dynamic Anchor Module (After Fusion)
# Dataset: Cityscapes | Supervised Training
# DA Position: After feature fusion (operates on fused backbone features)
# ---------------------------------------------------------------
...
model = dict(
    ...
    decode_head=dict(
        ...
        in_channels=512,  # DDRNet fused_s4 channels (channels=64 → 64*8=512)
